...
export const uploadFileFromReadstream = async (readStream) => {
  return openai.files.create({
    file: readStream,
    purpose: "batch",
  });
...
export const createBatch = async (fileId) => {
...
export const retrieveBatch = async (batchId) => {
  return openai.batches.retrieve(batchId);
};

export const retrieveOutputFile = async (outputfileId) => {
